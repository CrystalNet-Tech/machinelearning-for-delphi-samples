...
## Overview
Product Sales Spike Detection is a simple console application which builds and consumes time series anomaly detection models to detect [spikes](#spike-detection) and [change points](#change-point-detection) in product sales.

This is an end-to-end sample which shows how you can use [ML.Net Core for delphi](https://crystalnet-tech.com/Products/mldotNetCore4Delphi/Default) and spike and change point detection in a Console application.
...
var tansformedModel: IMLTransformer := estimator.Fit(CreateEmptyDataView());
```
